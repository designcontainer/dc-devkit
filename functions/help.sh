...
Basic commands:
    ...
    ${cmd}-w, wpe <page>${end}                      Open WP Engine panel for site, <-h, --help> to see args
...
Development:
    ...
    ${cmd}db, database <arg>${end}                  Fetch or export databases, <-h, --help> to see args
    ${cmd}remove${end}                              Remove site from computer. Includes files, vhosts and database

Server:
    ${cmd}mamp${end}                                Restarts MAMP, <-h, --help> to see args
